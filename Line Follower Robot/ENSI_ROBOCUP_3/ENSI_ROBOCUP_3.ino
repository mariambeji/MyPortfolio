...
static uint8_t ROBOT_LeftSensorState_u8 = 0, ROBOT_LeftCenterSensorState_u8 = 0, ROBOT_RightCenterSensorState_u8 = 0, ROBOT_RightSensorState_u8 = 0, ROBOT_CenterSensorState_u8 = 0;
...
ROBOT_States_ten ROBOT_CurrentState_en = ROBOT_MovingSlope_en;
...
void loop() {
  ...
  switch (ROBOT_CurrentState_en)
  {
    case ROBOT_Idle_en:
      {
        ROBOT_vForward();
        if (millis() - ROBOT_StartTime_u32 > 500)
        {
    ...
    case ROBOT_BlackFollower_en:
      {
        ...
        if ((ROBOT_LeftSensorState_u8 == BLACK) && (ROBOT_RightSensorState_u8 == BLACK) && (ROBOT_LeftCenterSensorState_u8 == BLACK) && (ROBOT_RightCenterSensorState_u8 == BLACK))
        {
          ROBOT_CurrentState_en = ROBOT_WhiteFollower_en;
    ...
    case ROBOT_WhiteFollower_en:
      {
        ...
        {
          ROBOT_CurrentState_en = ROBOT_TrafficCircle_en;
        }
      } break;
    case ROBOT_TrafficCircle_en:
      {
        ...
        {
          ROBOT_CurrentState_en = ROBOT_CircleLabyrith_en;
        }
      } break;
    case ROBOT_CircleLabyrith_en:
      {
        ...
        {
          ROBOT_CurrentState_en = ROBOT_Labyrinth_en;
        }
      } break;
    case ROBOT_Labyrinth_en:
      {
        ...
        {
          ROBOT_CurrentState_en = ROBOT_MovingSlope_en;
        }
        /*if ((ROBOT_LeftSensorState_u8 == WHITE) && (ROBOT_RightSensorState_u8 == WHITE) && (ROBOT_LeftCenterSensorState_u8 == WHITE) && (ROBOT_RightCenterSensorState_u8 == WHITE))
          {
           ROBOT_CurrentState_en = ROBOT_MovingSlope_en;
          } */
      } break;
    case ROBOT_MovingSlope_en:
      {
        ...
        if ((ROBOT_LeftSensorState_u8 == BLACK) && (ROBOT_RightSensorState_u8 == BLACK) && (ROBOT_LeftCenterSensorState_u8 == BLACK) && (ROBOT_RightCenterSensorState_u8 == BLACK))
        {
          ...
          delay(2000);
          ROBOT_CurrentState_en = ROBOT_ObjectDetection_en;
        }
      } break;
    case ROBOT_ObjectDetection_en:
      {
        ...
        if (ROBOT_ObjectDetected_b == true)
        {
          ...
          ROBOT_CurrentState_en = ROBOT_Snake_en;
        }
...
void ROBOT_vReadSensors()
{
  ...
  //Serial.println(ROBOT_RightCenterSensorState_u8);
}
void ROBOT_vForward1()
{
...
void ROBOT_vBlackFollower()
{
  if ((ROBOT_LeftCenterSensorState_u8 == BLACK) && (ROBOT_RightCenterSensorState_u8 == BLACK) && (ROBOT_RightSensorState_u8 == BLACK) && ( ROBOT_CurrentState_en ==ROBOT_BlackFollower_en) )
  {
    ROBOT_vRight();
  }
...
void ROBOT_vWhiteFollower()
{
  if ((ROBOT_LeftCenterSensorState_u8 == WHITE) && (ROBOT_RightCenterSensorState_u8 == WHITE) && (ROBOT_LeftSensorState_u8 == WHITE) && (ROBOT_RightSensorState_u8 == WHITE))
  {
...
{
  ROBOT_vRight();
  delay(500);  /* to change with encoder steps */
  ROBOT_vReadSensors();
  ...
  ROBOT_vRight();
  delay(500); /* to change with encoder steps */
  while (!((ROBOT_LeftSensorState_u8 == WHITE) && (ROBOT_RightSensorState_u8 == WHITE) && (ROBOT_LeftCenterSensorState_u8 == WHITE) && (ROBOT_RightCenterSensorState_u8 == WHITE)))
  {
    ROBOT_vReadSensors();
    ROBOT_vWhiteFollower();
  }
...
{ 
  ...
  Serial.println(ROBOT_ObjectDetected_b);
  if (  ROBOT_Distance_f > 10.0  /*&&  (ROBOT_Distance_f < 100.0)*/  ) 
  {
  ...
  roboclaw.SpeedM1M2(address,0,0);
  ROBOT_Distance_f = ROBOT_fReadDistance();
  if ( ( ROBOT_Distance_f >=26.0 ) && ( ROBOT_Distance_f <=100.0)  ) 
  {
        ROBOT_ObjectDetected_b = true;
    }*/
